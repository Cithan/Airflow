...
create_table = '''
 create or replace table dbt_snowflake.public.customer (
 cust_id int,
...
insert_data = '''
INSERT INTO dbt_snowflake.public.customer VALUES
...
update_data = '''
UPDATE dbt_snowflake.public.customer SET city = 'Bandung' WHERE cust_id = 005
'''

# create query for delete data in snowflake
delete_query = '''
delete from dbt_snowflake.public.customer 
'''
...
with dag:
    ...
    delete_data_table = SnowflakeOperator(
...
# Execute DAG
create_new_table >> insert_data_table >> update_data_table >> delete_data_table